...
public class HttpStructureContainer : HowlerStructureBuilder
{
    ...
    {
        HowlerRegistration.AddStructure<IControllerResponse?>(StructuresIds.Get,
            method => Provider.GetRequiredService<IHttpStructure>().GetStructure(method));     
        
        HowlerRegistration.AddVoidStructure<Dto?>(StructuresIds.Post, 
...
public class InfrastructureStructureContainer : HowlerStructureBuilder
{
    public override void InvokeRegistrations()
    {
        HowlerRegistration.AddDataTransferStructure<EmailDto>(StructuresIds.SendEmail, 
            data => Provider.GetRequiredService<INotificationStructure>().SendEmail(data));

        HowlerRegistration.AddDataTransferStructure<SmsDto>(StructuresIds.SendSms, 
        ...
        HowlerRegistration.AddDataTransferStructure<MicroServiceCommunicationStructureData, Task<MicroServiceResult?>>(StructuresIds.NotifyMicroService,
